...
func shortifyRoute(writer http.ResponseWriter, request *http.Request) {
...
func fullRoute(writer http.ResponseWriter, request *http.Request) {
...
func routeHandler(writer http.ResponseWriter, request *http.Request) {
	...
	case "/":
		shortifyRoute(writer, request)
	default:
		fullRoute(writer, request)
	}
}
